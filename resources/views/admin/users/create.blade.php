            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="create-laguage" action="{{ route('admin.users.users-store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <!-- Tab panes -->
                                ...
                                <div class="form-group">
                                    <label for="password-confirm">Password-Confirm <span class="text-danger">*</span></label>
